...
namespace Clarifai.DTOs.Models
{
    ...
    public class EmbeddingModel : Model<Embedding>
    {
        ...
        public EmbeddingModel(IClarifaiClient client, string modelID, string name = null,
        ...
        public new static EmbeddingModel Deserialize(IClarifaiClient client, dynamic model)
        {
