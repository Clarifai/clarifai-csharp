...
{
    /// <summary>
    /// Certain information regarding the Color model.
    /// </summary>
    public class ColorOutputInfo : IOutputInfo
    {
        /// <inheritdoc />
        ...
        public static ColorOutputInfo Deserialize(dynamic jsonObject)
        {
        ...
        {
            return obj is ColorOutputInfo info &&
        ...
        {
            return $"[ColorOutputInfo: (Concepts: {Concepts})]";
        }
    }
}
