...
namespace Clarifai.DTOs.Models.OutputsInfo
{
    ...
    public class FaceConceptsOutputInfo : IOutputInfo
    {
        ...
        public FaceConceptsOutputInfo(IEnumerable<Concept> concepts,
        ...
        public static FaceConceptsOutputInfo GrpcDeserialize(OutputInfo outputInfo)
        {
            List<Concept> concepts = null;
        ...
        {
            return obj is FaceConceptsOutputInfo info &&
        ...
        {
            return $"[FaceConceptsOutputInfo: (Concepts: {Concepts})]";
        }
    }
}
