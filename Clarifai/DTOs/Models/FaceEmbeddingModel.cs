...
namespace Clarifai.DTOs.Models
{
    ...
    public class FaceEmbeddingModel : Model<FaceEmbedding>
    {
        ...
        public FaceEmbeddingModel(IClarifaiHttpClient httpClient, string modelID,
            string name = null, DateTime? createdAt = null, string appID = null,
            ModelVersion modelVersion = null, FaceEmbeddingOutputInfo outputInfo = null)
        ...
        public new static FaceEmbeddingModel Deserialize(IClarifaiHttpClient httpClient,
            dynamic model)
        {
        ...
        /// <returns>a new instance</returns>
        public new static FaceEmbeddingModel GrpcDeserialize(IClarifaiHttpClient httpClient,
            Internal.GRPC.Model model)
        {
            return new FaceEmbeddingModel(
                ...
                appID: model.AppId,
                outputInfo: FaceEmbeddingOutputInfo.GrpcDeserialize(model.OutputInfo),
