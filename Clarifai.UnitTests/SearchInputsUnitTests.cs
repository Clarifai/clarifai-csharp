...
namespace Clarifai.UnitTests
{
    ...
    {
        [Test]
        public async Task SearchInputsByConceptIDRequestAndResponseShouldBeCorrect()
        {
...
");
        ...
        [Test]
        public async Task SearchInputsByConceptNameRequestAndResponseShouldBeCorrect()
        {
            var httpClient = new FkClarifaiHttpClient(
                postResponse: @"
{
...
");
        ...
        [Test]
        public async Task SearchInputsByURLRequestAndResponseShouldBeCorrect()
        {
            var httpClient = new FkClarifaiHttpClient(
                postResponse: @"
{
...
");
            ...
            var client = new ClarifaiClient(httpClient);
            var response = await client.SearchInputs(SearchBy.ImageURL("https://some-image-url"))
                .ExecuteAsync();
